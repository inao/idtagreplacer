...
/**
 * <p>
 * 文字編集記号クラスの、インターフェイスとして利用するクラスです。
 * </p>
 * <p>
 * 文字編集記号クラスは、変換元となる開始／終了記号と、変換先のスタイル情報を保持します。 具体的な変換処理の内容は、サブクラスで実装します。
 * </p>
 * <p>
 * 構造は単純です。パラメータとなる編集記号やスタイル情報を受け取るコンストラクタと、 変換処理を行う <code>convertSign</code>
 * メソッドがあるだけです。
 * </p>
 */
