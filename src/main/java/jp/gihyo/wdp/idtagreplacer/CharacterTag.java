...
/**
 * <p>
 * タグ設定ファイルから読み込まれた、文字スタイルの情報を格納するためのクラスです。
 * </p>
 * <p>
 * このオブジェクトの動作は極めて単純です。 オブジェクトはコンストラクタで渡されたスタイル名を保持し、
 * <code>getStartTagString</code> メソッドが呼ばれた際に、
 * <code>&lt;CharStyle: ... &gt;</code> というタグ文字列を作成して返します。
 * </p>
 */
public class CharacterTag {
	...
	/**
	 * 開始タグの文字列を返します。 具体的には、&lt;CharStyle:<i>style name</i>&gt;という文字列を返します。
	...
	/**
	 * 終了タグの文字列を返します。 返す値は &lt;CharStyle:&gt; です。
	 * 
