...
public abstract class ParagraphSign {
	 ...
	 *             タグ変換時にエラーが起こった場合
	 */
	public String convertSign(String line) throws IOException,
	...
	/**
	 * このメソッドは、処理対象の行に開始記号が見つかった場合にconvertSignメソッドから呼び出されます。 ここで具体的な変換処理が実行されます。
	 * 
	 * @param line
	 *            処理対象の行
	 * @throws IOException
	 ...
	 *             タグ変換時にエラーが起こった場合
	 */
	protected abstract String whenStartSignMuches(String line)
			throws IOException, SourceParserException;

	/**
	 * このメソッドは、処理対象の行に終了記号が見つかった場合にconvertSignメソッドから呼び出されます。 ここで具体的な処理が実行されます。
	 * 
	 * @param line
	 *            処理対象の行
	 * @throws IOException
	 ...
	 *             タグ変換時にエラーが起こった場合
	 */
	protected abstract String whenEndSignMuches(String line)
			throws IOException, SourceParserException;
}