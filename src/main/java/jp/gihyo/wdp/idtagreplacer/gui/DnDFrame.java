...
/**
 * これは、アプリケーションのメインウィンドウです。 ウィンドウの中身は、MainPanel オブジェクトです。
 */
class DnDFrame implements MainFrame {
	 ...
	 * 
	 * @see
	 * jp.gihyo.wdp.idtagreplacer.gui.MainFrame#setContentPane(jp.gihyo.wdp.
	 * idtagreplacer.gui.DnDMainPanel)
	 */
	@Override
	...
	void createFrame() {
		if (caption == null)
			frame = new JFrame("InDesign Tag Replacer");
		else
	 ...
	 * 
	 * @see
	 * jp.gihyo.wdp.idtagreplacer.gui.MainFrame#showErrorMessage(java.lang.String
	 * )
	 */
	@Override
	public void showErrorMessage(String message) {
		MessageThread t = new MessageThread("エラー", message,
	 ...
	 * 
	 * @see
	 * jp.gihyo.wdp.idtagreplacer.gui.MainFrame#showMessage(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	public void showMessage(String title, String message) {
		MessageThread t = new MessageThread(title, message,
	 ...
	 * 
	 * @see
	 * jp.gihyo.wdp.idtagreplacer.gui.MainFrame#setStatusMessage(java.lang.String
	 * )
	 */
	@Override
